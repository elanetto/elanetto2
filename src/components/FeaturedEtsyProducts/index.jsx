...
export default function FeaturedEtsyProducts() {
  const products = [
    ...
    {
      title: "Coffee Time Sticker Sheet",
      image: coffeeSheet,
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        {products.map((item, index) => (
          ...
          >
            ...
            />
            <div className="p-4">
              <h3 className="font-semibold text-pink-800 text-sm text-center">
                {item.title}
              </h3>
            </div>
          </a>
